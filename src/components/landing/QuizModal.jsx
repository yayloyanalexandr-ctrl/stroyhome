...
const steps = [
  {
    ...
    icon: Home,
    options: ['Небольшой дом до 100 м²', 'Дом 100–150 м²', 'Коттедж 150–250 м²', 'Особняк от 250 м²'],
  },
  {
    id: 'material',
    question: 'Из какого материала хотите дом?',
    icon: Layers,
    options: ['Газобетон', 'Кирпич', 'Каркасный дом', 'Ещё не определился'],
  },
  {
    id: 'location',
    question: 'Где планируете строить?',
    icon: MapPin,
    options: ['Ростов-на-Дону', 'Пригород Ростова', 'Другой город области', 'Ещё ищу участок'],
  },
  {
    id: 'budget',
    question: 'Какой бюджет на строительство?',
    icon: Wallet,
    options: ['До 5 млн ₽', '5–10 млн ₽', '10–20 млн ₽', 'Свыше 20 млн ₽'],
  },
];
