    ...
    <section id="about" className="py-24 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Компания «Южный Дом» — это команда профессионалов, которая помогает семьям обрести дом мечты в Ростовской областиный 
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 lg:mb-20">
          ...
          <motion.div
            ...
            <p className="text-muted-foreground leading-relaxed">
              За более чем 12 лет работы мы построили свыше 350 домов в Ростове-на-Дону и Ростовской области. Наша компания предоставляет полный спектр услуг — от подбора земельного участка и проектирования до строительства и ввода дома в эксплуатацию.
            </p>
            <p className="text-muted-foreground leading-relaxed">
