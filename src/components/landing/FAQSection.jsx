...
const faqs = [
  {
    ...
    a: 'Стоимость зависит от площади, материалов и сложности проекта. Цены начинаются от 3.2 млн ₽ за дом площадью 100 м². Мы предоставляем подробную смету до начала строительства.',
  },
  {
    q: 'Какие материалы вы используете?',
    a: 'Мы работаем с газобетоном, кирпичом, каркасными технологиями и SIP-панелями. Все материалы сертифицированы и соответствуют строительным нормам.',
  },
  {
